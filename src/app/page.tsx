  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="py-3 px-4 bg-plum/5 border-b border-charcoal/5 text-center">
          <p className="text-sm text-charcoal/60">
            <span className="font-semibold text-charcoal/80">Global Participants</span>
            {" "}&mdash;{" "}Cameroon &middot; Nigeria &middot; Canada &middot; France &middot; United States
          </p>
        </div>
