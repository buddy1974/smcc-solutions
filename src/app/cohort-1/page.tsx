...
export const metadata: Metadata = {
  title: "SMCC Certification Program – Christian Marriage Counseling Training",
  description:
    "Earn your Christian marriage counseling certification through the SMCC 12-week Cohort I program. Biblical frameworks, live mentoring, and professional certification.",
  openGraph: {
    title: "SMCC Certification Program – Christian Marriage Counseling Training",
    description:
      "Earn your Christian marriage counseling certification through the SMCC 12-week Cohort I program. Biblical frameworks, live mentoring, and professional certification.",
  ...
  return (
    <>
      <JsonLd data={{
        ...
        "description": "12-week Christian marriage counseling and coaching certification",
        "provider": { "@type": "EducationalOrganization", "name": "SMCC", "url": "https://smcc.solutions" },
        "offers": { "@type": "Offer", "price": "50000", "priceCurrency": "XAF" },
      }} />
      <Navbar />
      <main>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-14 rounded-xl bg-plum/5 border border-plum/10 p-8 max-w-2xl mx-auto">
              ...
              <ol className="space-y-4">
                {[
                  "Select your program on the payment page",
                  "Secure payment via PayUnit (50,000 XAF)",
                  "Receive confirmation email and WhatsApp",
        ...
        <section className="py-16 px-4" style={{ backgroundColor: "#0d0010" }}>
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm mb-8" style={{ color: "rgba(232,213,234,0.50)" }}>
              Our admissions team is ready to help. Contact us on WhatsApp.
            </p>
            <a
      ...
      <a
        ...
        aria-label="Contact SMCC Admissions on WhatsApp"
      >
